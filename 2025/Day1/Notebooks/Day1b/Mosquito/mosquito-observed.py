...
# this is to simulate the OBSERVED data

# possible statistics to calculate: https://tskit.dev/tskit/docs/stable/stats.html
...
# Output file name
output_file = os.path.join(output_directory, "mosquito-observed.csv")
...
with open(output_file, "w", newline="") as csvfile:
    ...
    # Write header
    writer.writerow(["Fst", "dxy", "segsites1", "segsites2", "pi1", "pi2", "tajima1", "tajima2"])
            ...
            for T_split in T_splits:
                for mig_rate in migration_rates:
                    ...
                    for i in range(1):
                        ...
                        writer.writerow([Fst, dxy, ssites[0], ssites[1], div[0], div[1], tajima[0], tajima[1]])
